...
const i18n = {
  en: {
    ...
    heroCtaPrimary: "Get early access",
    ...
    faqA5:
      "Pricing isn't final yet. The core app — tracking, manual trips, and basic reports — stays free. Early testers will hear about Pro plans first.",
    faqQ6: "When does it launch?",
    faqA6:
      "The app is in active testing now. Join the tester list below and we'll send you a build for your phone as soon as it's ready.",
    downloadEyebrow: "Early access",
    downloadTitle: "Be first in line when MarV Route launches.",
    downloadBody:
      "The mobile app is moving toward release. Join the tester list and we'll reach out with a build for your phone — and your feedback will shape what ships.",
    formName: "Name",
    ...
    formConsent:
      'I agree to be contacted about MarV Route early access. See our <a href="privacy/index.html">Privacy Policy</a>.',
    formSubmit: "Join the tester list",
    footerSupport: "Support",
    footerPrivacy: "Privacy",
    footerTop: "Back to top",
    formSending: "Sending…",
    formSuccess: "{name}, you're on the tester list. We'll be in touch soon.",
  ...
  uk: {
    ...
    heroCtaPrimary: "Отримати ранній доступ",
    ...
    faqA5:
      "Ціни ще не остаточні. Основний додаток — відстеження, ручні поїздки та базові звіти — залишається безкоштовним. Ранні тестери дізнаються про плани Pro першими.",
    faqQ6: "Коли реліз?",
    faqA6:
      "Додаток зараз активно тестується. Долучайтеся до списку тестерів нижче — і ми надішлемо вам збірку на телефон, щойно вона буде готова.",
    downloadEyebrow: "Ранній доступ",
    downloadTitle: "Будьте першими, коли MarV Route вийде.",
    downloadBody:
      "Мобільний додаток наближається до релізу. Долучайтеся до списку тестерів — ми надішлемо збірку на ваш телефон, а ваш відгук вплине на те, що вийде.",
    formName: "Ім'я",
    ...
    formConsent:
      'Я погоджуюся отримувати листи про ранній доступ до MarV Route. Див. нашу <a href="privacy/index.html">Політику конфіденційності</a>.',
    formSubmit: "Долучитися до тестерів",
    footerSupport: "Підтримка",
    footerPrivacy: "Конфіденційність",
    footerTop: "Нагору",
    formSending: "Надсилаємо…",
    formSuccess: "{name}, вас додано до списку тестерів. Ми скоро зв'яжемося.",
